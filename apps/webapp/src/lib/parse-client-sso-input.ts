/**
 * Validates superadmin PUT payloads for `ssoConfig` and merges with existing
 * OIDC/SAML secrets when the UI leaves a secret field blank on edit.
 *
 * Ported verbatim from ct-csa-standalone's lib/parse-client-sso-input.ts.
 */

import type { CsaClient, ClientSsoConfigStored } from '@/lib/mongo-clients';
